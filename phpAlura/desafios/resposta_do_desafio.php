<?php
# Versão do codigo realizada pelo professor da alura de PHP, implementando function e loop do do e while
// Inicialização das variáveis
$saldo = 1_000.00; // Saldo inicial
$opcao = 0;

// Função para exibir o menu
function exibirMenu($saldo)
{
    echo "******************\n";
